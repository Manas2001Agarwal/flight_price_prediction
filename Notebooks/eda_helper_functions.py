...
# pair plots
def pair_plots(data,
               height=3, # width of each graph
               aspect=1.5, #length  = height * aspect_ratio
               hue=None,
               legend=False):
...
def correlation_heatmap(data,
  ...
  mask[np.triu_indices_from(mask)] = True #get the indices of upper triangular matrices filter them and set them to true
